...
$layout->blocks["top"][] = "details";$page_layouts["users_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='users_edit.php?".$editlink."'\"");
