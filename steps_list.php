...
$layout = new TLayout("list3","Rounded1Blue_white1","MobileBlue_white1");
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["steps_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "tutorial_id";
			}
...
$viewControls = new ViewControlsContainer(new ProjectSettings("tutorial", PAGE_LIST), PAGE_LIST);
