...
include_once("include/steps_settings.php");
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["tutorial_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "tutorial_name";
		}
...
$viewControls = new ViewControlsContainer(new ProjectSettings("tutorial_categories", PAGE_LIST), PAGE_LIST);
