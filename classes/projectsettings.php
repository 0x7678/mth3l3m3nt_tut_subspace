...
function GetTableURL($table = "")
{
	...
	if("tutorial" == $table) 
		return "tutorial";
	if("tutorial_categories" == $table) 
		return "tutorial_categories";
	if("users" == $table) 
		return "users";
	if("exploit_store" == $table) 
		return "exploit_store";
	if("View_Tutorials" == $table) 
...
{	
	...
	if("steps" == $shortTName) 
		return "steps";
	if("tutorial" == $shortTName) 
		return "tutorial";
	if("tutorial_categories" == $shortTName) 
		return "tutorial_categories";
	if("users" == $shortTName) 
		return "users";
	if("exploit_store" == $shortTName) 
		return "exploit_store";
	if("View_Tutorials" == $shortTName) 
		return "View_Tutorials";
}
