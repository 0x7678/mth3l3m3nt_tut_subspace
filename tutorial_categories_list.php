...
include_once("include/tutorial_settings.php");
include_once("include/exploit_store_settings.php");
...
$layout->blocks["top"][] = "recordcontrols";$page_layouts["tutorial_categories_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "cat_name";
	}
