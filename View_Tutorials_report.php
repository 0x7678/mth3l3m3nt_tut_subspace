...
$layout = new TLayout("report3","Rounded1Blue_white1","MobileBlue_white1");
...
$layout->blocks["top"][] = "hmenu";$page_layouts["View_Tutorials_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="View_Tutorials_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "View_Tutorials";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='View_Tutorials_search.php';return false;\"");
