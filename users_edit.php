...
$layout->blocks["top"][] = "details";$page_layouts["users_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "users_inline_edit.htm" : "users_edit.htm";
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='users_view.php?".$viewlink."'\"");
