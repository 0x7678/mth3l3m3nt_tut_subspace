...
class tDAL
{
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
	  $this->lstTables[]=array("name"=>"steps","varname"=>"steps");
	  $this->lstTables[]=array("name"=>"tutorial","varname"=>"tutorial");
	  $this->lstTables[]=array("name"=>"tutorial_categories","varname"=>"tutorial_categories");
	  $this->lstTables[]=array("name"=>"users","varname"=>"users");
	  $this->lstTables[]=array("name"=>"exploit_store","varname"=>"exploit_store");
	  $this->lstTables[]=array("name"=>"report_by_group","varname"=>"report_by_group");
	}
